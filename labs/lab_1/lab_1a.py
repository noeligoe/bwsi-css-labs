...
def main():
    ...
    name = "Noel Igoe" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print(f"Hello, my name is Noel Igoe. I am from Pennsylvania. I enjoy computer science and game development.")
